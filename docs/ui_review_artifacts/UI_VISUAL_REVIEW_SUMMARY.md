...
## Reference run set
- Validate run: `20260312_170515`
- Snapshot run: `20260312_170735`
- Doctor run: `20260312_170515`
...
## Notes
- This summary is machine-based.
- Human visual acceptance is still required for non-machine dimensions listed in `known_blind_spots`.
