...
| major | layout | floating_critical_cta | Language Hub | overview_loaded / review_and_stress_loaded | all scales and all sizes | `Refresh Language Blocks` stays anchored near language widgets | CTA reported as floating in both language states | Keep language hub CTA in a fixed top toolbar layout |
...
- `runtime/ui_validation/20260312_155348/screenshots/scale_1_0/doctor__language_hub__overview_loaded__1600x960__scale_1_0.png`
- `runtime/ui_validation/20260312_155348/screenshots/scale_1_0/doctor__language_hub__review_and_stress_loaded__1600x960__scale_1_0.png`
- `runtime/ui_validation/20260312_155348/screenshots/scale_1_0/doctor__companion__configured_invalid_executable__1600x960__scale_1_0.png`
- `runtime/ui_validation/20260312_155348/screenshots/scale_1_0/doctor__entries__many_items_loaded__1600x960__scale_1_0.png`
- `runtime/ui_validation/20260312_155348/screenshots/scale_1_0/doctor__translation__loaded_translations__1600x960__scale_1_0.png`

## Notes
- No critical blockers detected in this run.
- Major layout warnings remain systematic and include new Language Hub panel.
