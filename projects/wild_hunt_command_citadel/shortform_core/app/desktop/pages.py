...
class SessionsPage(BasePage):
    def __init__(self) -> None:
        ...
        chip_grid.addWidget(self.session_link_chip, 1, 0)
        chip_grid.addWidget(self.session_viewport_chip, 2, 0)
...
class AIStudioPage(BasePage):
    def __init__(self) -> None:
        ...
        gen_btn = MotionButton("Сформировать рекомендации")
        ...
        action_row.addWidget(bundle_btn, 1, 0)
