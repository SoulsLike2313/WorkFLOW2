...
$startupRaw = & $pythonExe $startupScript prepare --project-slug tiktok_agent_platform --startup-kind verify --port-mode $PortMode
if ($LASTEXITCODE -ne 0) {
    throw "Startup preflight failed for tiktok_agent_platform core verify mode."
}
